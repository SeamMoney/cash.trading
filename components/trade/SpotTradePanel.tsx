  ...
  return (
    <div>
      ...
      {amount && parseFloat(amount) > 0 && priceImpactSeverity(estimatePriceImpact(parseFloat(amount))) === "high" && (
        <div className="mt-3 flex items-center gap-2 px-3 py-2 rounded-[10px] bg-red-500/10 border border-red-500/12 text-[11px] font-mono text-red-400 animate-enter">
