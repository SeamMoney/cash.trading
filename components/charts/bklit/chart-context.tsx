...
export interface ChartContextValue extends ChartHoverContextValue {
  ...
  columnWidth: number;
  /** Instance-scoped SVG fills for candlestick bodies. */
  candlestickPositiveFill?: string;
  candlestickNegativeFill?: string;
...
export function ChartProvider({
  ...
  const stable = useMemo<ChartStableContextValue>(
    () => ({
      ...
      candlestickPositiveFill: value.candlestickPositiveFill,
      candlestickNegativeFill: value.candlestickNegativeFill,
    ...
    [
      ...
      value.margin,
      value.columnWidth,
      value.candlestickPositiveFill,
      value.candlestickNegativeFill,
      value.containerRef,
      value.lines,
