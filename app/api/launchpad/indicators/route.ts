...
const SEED: IndicatorEntry[] = [
  ...
  },
  {
    ...
    symbol: "SMALV",
    description: "SMA(10)/SMA(30) crossover on BTC/USD. Signals computed on-chain in Move from real Pyth prices and emitted as on-chain events — not yet trading funds.",
    assets: ["BTC/USD"],
  ...
  },
  {
    ...
    name: "RSI Momentum",
    symbol: "RSIMOM",
    description: "RSI(15) oversold/overbought on ETH. Signals computed on-chain in Move from real Pyth prices; BUY below 30 / SELL above 70 — not yet trading funds.",
  ...
  },
  {
    ...
    symbol: "SMACR",
    description: "SMA(5)/SMA(20) golden-cross on BTC — computed on-chain in Move; faster crossover than SMALV, catches short-term momentum.",
  ...
  },
  {
    ...
    name: "EMA Ribbon",
    symbol: "EMARIB",
    description: "EMA(20)/EMA(55) ribbon on ETH — computed on-chain in Move; exponential weighting catches trend reversals faster than SMA.",
  ...
  },
  {
    ...
    symbol: "MACDIV",
    description: "MACD(8,18,9) on BTC — computed on-chain in Move; histogram crossover above/below signal line triggers BUY/SELL.",
    assets: ["BTC/USD", "ETH/USD"],
  ...
  },
  {
    ...
    symbol: "BBPRO",
    description: "BB(20, 2σ) on BTC — computed on-chain in Move; mean reversion: BUY when price touches lower band, SELL at upper band.",
    assets: ["BTC/USD", "ETH/USD"],
  ...
  },
  {
    ...
    name: "Stochastic Pro",
    symbol: "STOCHPRO",
    description: "Stochastic(14,3) on BTC — computed on-chain in Move; %K/%D oscillator: BUY below 20 (oversold), SELL above 80 (overbought).",
    assets: ["BTC/USD", "ETH/USD"],
  ...
  },
  {
    ...
    name: "SuperTrend ETH",
    symbol: "STETH",
    description: "SuperTrend(10, 3.0) on ETH — computed on-chain in Move; ATR-based trend filter: flips BUY/SELL on band crossover. Rides trends, cuts noise.",
    assets: ["ETH/USD", "BTC/USD"],
  ...
  },
  {
    ...
    name: "KAMA BTC",
    symbol: "KAMABTC",
    description: "Kaufman Adaptive MA(10,30) on BTC — computed on-chain in Move; efficiency ratio adapts smoothing: fast in trends, slow in choppy markets.",
    assets: ["BTC/USD", "ETH/USD"],
    createdAt: Date.now() - 1 * 3600_000,
  ...
  },
  {
    ...
    name: "ALMA ETH",
    symbol: "ALMAETH",
    description: "Arnaud Legoux MA(9, 0.85σ) on ETH — computed on-chain in Move; Gaussian-weighted MA minimizes lag; catches reversals faster than SMA/EMA.",
    assets: ["ETH/USD", "BTC/USD"],
    createdAt: Date.now() - 2 * 3600_000,
  ...
  },
  {
    ...
    name: "T3 BTC",
    symbol: "T3BTC",
    description: "Triple EMA T3(5, 0.7) on BTC — computed on-chain in Move; 6x chained EMA with Tillson GD function; minimal lag with reduced whipsaws.",
    assets: ["BTC/USD", "ETH/USD"],
  ...
  },
  {
    ...
    name: "Laguerre RSI",
    symbol: "LAGRSI",
    description: "Laguerre RSI(γ=0.70) on ETH — computed on-chain in Move; 4-pole Laguerre filter RSI. Low lag, early reversal detection. BUY <0.2, SELL >0.8.",
    assets: ["ETH/USD", "BTC/USD"],
  ...
  },
  {
    ...
    symbol: "DONBTC",
    description: "Donchian(20) on BTC — computed on-chain in Move; breakout signal: BUY on new 20-period high, SELL on new 20-period low.",
