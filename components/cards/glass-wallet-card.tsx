...
export function GlassWalletCard({
  ...
  return (
    ...
    >
      <Card className="group relative h-60 w-full overflow-hidden rounded-2xl border-border/50 bg-gradient-to-br from-card/80 via-card/40 to-card/20 backdrop-blur-md transition-all duration-300 hover:border-primary/18 hover:shadow-xl hover:shadow-primary/10">
