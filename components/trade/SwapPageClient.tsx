...
export function SwapPageClient() {
  ...
  return (
    // The same shell every other page uses: cash-trade-theme scopes the accent
    // vars the Header reads, and min-h-screen keeps the page background from
    // showing through under a short form.
